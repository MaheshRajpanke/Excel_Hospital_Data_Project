...
An interactive **Hospital Emergency Room Dashboard** built entirely in **Microsoft Excel** to monitor patient flow, operational efficiency, waiting time, admissions, referrals, and patient satisfaction through dynamic dashboards and KPI reporting.
...
The objective of this project is to transform raw Emergency Room (ER) data into meaningful business insights that help hospital management monitor operational performance, identify patient trends, and support data-driven decision making using an interactive Excel dashboard.
